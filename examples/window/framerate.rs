...
pub(crate) mod wasm {
    ...
    pub static EVENT_LOOP_PROXY: Lazy<Arc<Mutex<Option<EventLoopProxy<WakeUp>>>>> =
    ...
    pub(crate) fn setup_external_redraw(event_loop_proxy: NonSend<EventLoopProxy<WakeUp>>) {
